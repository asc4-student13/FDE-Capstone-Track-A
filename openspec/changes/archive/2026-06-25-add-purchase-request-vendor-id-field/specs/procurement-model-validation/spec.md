...
The system SHALL define a PurchaseRequest model with typed required fields for request identity, requester, cost center, vendor name, vendor identifier, category, item details, quantity, unit price, and total amount.
